...
{
    private $baseUrl = "http://localhost:3000/referenciaBioquimica";

    /**
     * Buscar os valores de referência da bioquímica
     */
    public function buscarReferencia()
    {
        ...
        try {
            ...
            error_log("Erro ao buscar referência bioquímica: " . $e->getMessage());
            return null;
        }
    }

    /**
     * Atualizar os valores de referência da bioquímica
     */
    ...
    /**
     * Converter dados da API para objeto ReferenciaBioquimica
     */
