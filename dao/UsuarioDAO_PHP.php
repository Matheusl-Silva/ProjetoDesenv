...
class UsuarioDAO
{
    ...
    public function listarUsuarios() //FEITO
    {
    ...
    public function atualizarUsuario(Usuario $usuario){ //FEITO
    ...
    public function excluirUsuario($email) //USUARIO
    {
    ...
    public function cadastrarUsuario(Usuario $usuario) //FEITO
    {
    ...
    public function buscarUsuario($id){ //FEITO
    ...
    public function verificarEmail($email) //FEITO
    {
        try {
    ...
    public function login($email, $senha) //FEITO
    {
        try {
