    ...
    <form action="/exameHemato" method="post" class="action-card shadow p-4">
      ...
      <div class="row g-3">
        <div class="col-md-4">
          ...
          <input type="text" step="0.01" name="hemacia" class="form-control exam-data">
        </div>
        <div class="col-md-4">
          <label class="form-label">Hemoglobina (g/dL)</label>
          <input type="text" step="0.1" name="hemoglobina"
            class="form-control exam-data">
        </div>
        <div class="col-md-4">
          <label class="form-label">Hematócrito (%)</label>
          <input type="text" step="0.1" name="hematocrito"
            class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">VCM (fL)</label>
          <input type="text" step="0.1" name="vcm" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">HCM (pg)</label>
          <input type="text" step="0.1" name="hcm" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">CHCM (g/dL)</label>
          <input type="text" step="0.1" name="chcm" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">RDW (%)</label>
          <input type="text" step="0.1" name="rdw" class="form-control exam-data">
        </div>
      </div>
      ...
      <div class="row g-3">
        <div class="col-md-3">
          ...
          <input type="text" name="leucocitos" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Neutrófilos (/µL)</label>
          <input type="text" name="neutrofilos" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Linfócitos (/µL)</label>
          <input type="text" name="linfocitos" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Monócitos (/µL)</label>
          <input type="text" name="monocitos" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Eosinófilos (/µL)</label>
          <input type="text" name="eosinofilos" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Basófilos (/µL)</label>
          <input type="text" name="basofilos" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Bastonetes (/µL)</label>
          <input type="text" name="bastonetes" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Blastos (/µL)</label>
          <input type="text" name="blastos" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Promielócitos (/µL)</label>
          <input type="text" name="promielocitos" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Mielócitos (/µL)</label>
          <input type="text" name="mielocitos" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Metamielócitos (/µL)</label>
          <input type="text" name="metamielocitos" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Segmentados (/µL)</label>
          <input type="text" name="segmentados" class="form-control exam-data">
        </div>
        <div class="col-md-3">
          <label class="form-label">Linfócitos Atípicos (/µL)</label>
          <input type="text" name="linfocitos_atipicos"
            class="form-control exam-data">
        </div>
        <div class="col-md-3">
      ...
      <div class="row g-3">
        <div class="col-md-6">
          ...
          <input type="text" name="plaquetas" class="form-control exam-data">
        </div>
        <div class="col-md-6">
          <label class="form-label">Volume Plaquetário Médio (fL)</label>
          <input type="text" step="0.1" name="volumePlaquetarioMedio" class="form-control exam-data">
        </div>
      </div>
